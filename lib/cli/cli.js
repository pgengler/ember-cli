  ...
  return Promise.hash(environment).then(function(environment) {
    ...
    if (!platform.isValid && !this.testing) {
      if (platform.isDeprecated) {
        this.ui.writeLine(deprecate('Node ' + process.version +
                                    ' is no longer supported by Ember CLI. Please update to a more recent version of Node', true));
      }
      if (platform.isUntested) {
        var chalk = require('chalk');
        this.ui.writeLine(chalk.yellow('WARNING: Node ' + process.version +
